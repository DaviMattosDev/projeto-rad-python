...
from controller.login import authenticate
from model.admin_module import admin_dashboard
from model.funcionario_module import funcionario_dashboard
from model.rh_module import rh_dashboard
from model.gestor_module import gestor_dashboard
